...
var CustomerComponent = (function () {
    ...
    CustomerComponent.prototype.loadData = function () {
        var _this = this;
        debugger;
    ...
    CustomerComponent.prototype.extractArray = function (res, showprogress) {
        if (showprogress === void 0) { showprogress = true; }
        var data = res.json();
        return data || [];
    };
    CustomerComponent.prototype.handleErrorPromise = function (error) {
        try {
